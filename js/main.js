...
function mostrar(){
 root.innerHTML= '<h1>'+ user_ob [posicion].nikname + '</h1>' +
 '<h1>' + user_ob [posicion].name + '</h1>'+
 '<h1>' + user_ob [posicion].adress +'</h1>'+
 '<h1>' + user_ob [posicion].email + '</h1>'+
 '<h1>' + user_ob [posicion].phone + '</h1>';
}
